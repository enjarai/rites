...
object Visuals {
    ...
    fun drawParticleCircleArm(
        ...
        val animationPosTo = ((currentTick % cycleTicks / cycleTicks.toDouble()) + cycleOffset - 0.05) * (2 * Math.PI)
        ...
        val movementVector = particlePosTo.subtract(particlePos).multiply(0.2)
