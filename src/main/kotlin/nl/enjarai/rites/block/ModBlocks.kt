...
object ModBlocks {
    val RITE_CENTER = RiteCenterBlock(FabricBlockSettings.create().noCollision().breakInstantly())
    val RITE_SUBCENTER = RiteSubCenterBlock(FabricBlockSettings.create().noCollision().breakInstantly())
    val RITE_FOCUS = RiteFocusBlock(FabricBlockSettings.create()
        .strength(3.0f).luminance { 15 }.nonOpaque()) { ModItems.RITE_FOCUS.defaultStack }
